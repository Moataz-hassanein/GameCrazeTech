...
const HardwarePage = () => {
  ...
  const keys = Object.keys(prod.specs);
          ...
          <div className="lg:col-gap-12 xl:col-gap-16 grid grid-cols-1 gap-12  lg:grid-cols-4 lg:gap-10">
                ...
                <div className="lg:order-2 lg:ml-5 ">
                  <div className="w-80 overflow-hidden rounded-lg">
                    <img
                      ...
                      alt={prod.image[currentImageIndex]}
                    />
                  </div>
                </div>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="py-2  flow-root ">
                <p className="text-lg sm:text-md text-slate-900">{prod.description}</p>
              </div>
            </div>
          </div>
        </div>
