...
const PcPage = () => {
  ...
  return (
    <Layout>
      <section className=" h-fit  py-10 sm:mt-5">
        <div className=" container mx-auto px-4">
          <div className="lg:col-gap-12 xl:col-gap-16 grid grid-cols-1 gap-12  lg:grid-cols-4 lg:gap-10">
              ...
              <div className="lg:flex lg:items-start">
                <div className="lg:order-2">
                  <div className="w-80 overflow-hidden rounded-lg ">
                    <img
                      className="w-3/5 sm:w-auto m-auto"
            ...
            <div className="lg:col-span-3 lg:row-span-2 lg:row-end-2">
              ...
              <ul className="pl-3 list-[circle] sm:list-disc">
            ...
            <div className="lg:col-span-3">
              <div className="border-b border-gray-300">
                <h1 className="my-2 text-3xl font-bold text-slate-900">
                  Product information
                </h1>
              </div>
